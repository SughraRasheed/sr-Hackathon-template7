...
export default function Home() {
  return (
    <div className="bg-[#f6f7f9] min-h-screen p-4 sm:p-6 lg:p-20 flex flex-col gap-8 font-[family-name:var(--font-geist-sans)]">
      ...
      <section className="popular w-full flex flex-col gap-6">
        <div className="first w-full flex items-center justify-between">
          <h1 className="text-gray-400 text-lg sm:text-xl font-medium mx-4">Popular Car</h1>
      ...
      <section className="popular w-full flex flex-col gap-8">
        <h1 className="text-gray-400 text-lg sm:text-xl font-medium mx-4">Recommendation Car</h1>
        <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="w-full max-w-[304px] mx-auto h-auto flex flex-col justify-between">
            ...
            <CardContent className="w-full flex flex-col items-center justify-center gap-14">
              <Image src={"/CR - V-Black.png"} alt="" width={220} height={68} />
              <Image src={"/Spesification5.png"} alt="" width={256} height={24} />
            </CardContent>
            <CardFooter className="w-full flex items-center justify-between">
              <p className="font-bold">
        ...
        <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="w-full max-w-[304px] mx-auto h-auto flex flex-col justify-between">
            ...
            <CardContent className="w-full flex flex-col items-center justify-center gap-14">
              <Image src={"/NewMG-ZS-Gray.png"} alt="" width={300} height={68} />
              <Image src={"/Spesification5.png"} alt="" width={256} height={24} />
            </CardContent>
            <CardFooter className="w-full flex items-center justify-between">
              <p className="font-bold">
